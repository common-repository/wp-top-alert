...
<section class="wpa_container">
    ...
    <div class="wpa_in_container">
        ...
        <div class="wpa_container_box">
            <strong style="font-size: <?php echo (get_option('wpa_alert_txt_font_size', 16) !== '') ? get_option('wpa_alert_txt_font_size', 16) : '16' ; ?>px"><?php echo get_option('wpa_alert_txt'); ?></strong>
