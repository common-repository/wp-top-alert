...
//alert text field font size
add_settings_field(
    'wpa_alert_txt_font_size',
    __('Alert Text Font Size (px)', 'wp_top_alert'),
    'wpa_alert_txt_font_size_function',
    'wpa_alert_settings',
    'wpa-alert-settings'
);
register_setting(
...
function wpa_alert_txt_font_size_function()
{
    $get = get_option( 'wpa_alert_txt_font_size' );
    ?>

    <input type="number" name="wpa_alert_txt_font_size" value="<?php echo $get; ?>" style="border: 1px solid #ddd; width: 30%" />
